					...
					<section class="images-example">
						...
						<?php
							...
							if ($wp_query->have_posts()) : while($wp_query->have_posts()) : $wp_query->the_post();
								...
								$portfolio_image = get_the_post_thumbnail($post->ID, 'portfolio_2', array('alt' => the_title_attribute('echo=0')));
									...
									if ($attachments) {
										foreach($attachments as $gallery ) {
											...
											if ($hidden_image_number > 0) {
												...
												//$image_attachment_url =  str_replace($site_url_images,'',$current_attachment_url);
