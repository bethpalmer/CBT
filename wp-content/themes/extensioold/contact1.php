...
?>
				...
				<div id="main">
					<!-- intro -->
					<section class="intro">
						<?php if (get_option($shortname."_search_contact") == 'true') { ?>
						<!-- search -->
					...
					<div class="main-holder">
							...
							<article class="article-alt">
								<div class="txt">
									...
									<div class="headline solid">
										<h2><?php _e('Find us on map','extensio'); ?></h2>
									</div>
									<p><iframe width="650" height="475" src="<?php echo get_option($shortname."_google_map"); ?>" style="color:#0000FF;text-align:left; border:0px solid #ddd; padding:0px; background:#fff;"></iframe></p>
									<?php } ?>
						...
						<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("Contact Form") ) : ?>
							...
							<form method="post" class="comments-form" id="main_comment_form" action="#msgConfirmation">
								...
								<fieldset>
									...
									<div class="row">
										<label for="username"><?php _e('Your Name','extensio'); ?> <span>(*)</span></label>
						...
						<!-- sidebar -->
						<aside class="col contactbar" id="sidebar">
