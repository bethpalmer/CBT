...
class feedburner_subscribe_Widget extends WP_Widget {
	...
	function feedburner_subscribe_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'feedburner_subscribe-widget', 'Extensio - Feedburner Subscribe', $widget_ops, $control_ops );
	}
...
?>					
		...
		<section class="newsletter">
			<form action="http://feedburner.google.com/fb/a/mailverify?" method="post" target="_blank">
				<fieldset>
					<input type="text" name="email" value="<?php _e('Enter your email here','extensio'); ?>" class="text" />
