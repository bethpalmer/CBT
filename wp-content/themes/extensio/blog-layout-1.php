							...
							<article class="article">
								<footer class="info info-alt">
									...
									<nav class="social-networks">
										<ul>
											<li><a href="https://twitter.com/home/?status=<?php the_title(); ?> - <?php echo urlencode(get_permalink($post->ID)); ?>" title="<?php _e('Share on Twitter','extensio'); ?>" rel="nofollow"><?php _e('Share on Twitter','extensio'); ?></a></li><li><a class="facebook" href="https://www.facebook.com/share.php?u=<?php the_permalink(); ?>" title="<?php _e('Share on Facebook','extensio'); ?>"><?php _e('Share on Facebook','extensio'); ?></a></li>
