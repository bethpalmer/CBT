...
$meta_box = array(
    ...
    'fields' => array(
		array(
            'name' => 'Custom Page Heading',
            'desc' => 'Enter page title to show instead the page name.',
		...
		array(
            'name' => 'Select Sidebar',
            'desc' => 'Select sidebar and enter data to it in Appearance -> Widgets.',
            'id' => 'current_sidebar',
            'type' => 'custom_sidebars'
        ),
		array(
            'name' => 'Select Footer Widget',
            'desc' => 'Select footer widget. You can show another information in footer for this page. By default are displayed the Footer Widgets Sidebars.',
            'id' => 'custom_footer',
            'type' => 'custom_footer_sidebars'
        ),
		array(
            'name' => 'Disable Footer',
            'desc' => 'Check this option to hide the entire footer from this page.',
            'id' => 'footer_widget_enable',
            'type' => 'checkbox'
        ),
		array(
            'name' => 'Disable SubFooter',
            'desc' => 'Check this option to hide the entire subfooter from this page.',
            'id' => 'subfooter_enable',
            'type' => 'checkbox'
        )
    )
