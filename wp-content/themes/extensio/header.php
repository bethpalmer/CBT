...
//						} 
					...
					?>
					<a href="/">
						<img class="" src="http://www.thebritishcbtcounsellingservice.com/wp-content/uploads/2012/07/Companylogo.jpg" width="330" height="62" alt="The British CBT & Counselling Service" border="0">
					</a>
					<div class="call">Call: <span class="phonetop"><a href="tel:08000029068">0800 002 9068</a></span><br><span class="onlinebookingbutton"><script id="timelyScript" src="//book.gettimely.com/widget/book-button-v1.3.js"></script>
						<?php
						//if ( is_singular() )
    				//$post = get_post( get_the_ID() );
						
						$booking_button = get_post_meta($post->ID, 'booking_button', true);
						if (empty($booking_button)) {
						$booking_button = '<script>new timelyButton("thebritishcbtcounsellingservice", {"imgSrc":"http://www.thebritishcbtcounsellingservice.com/wp-content/uploads/2016/09/bookonlinebutton.jpg"});</script>';
						} else {
						$booking_button = str_replace('"staff"','"imgSrc":"http://www.thebritishcbtcounsellingservice.com/wp-content/uploads/2016/09/bookonlinebutton.jpg","staff"',$booking_button);
$booking_button = str_replace('"location"','"imgSrc":"http://www.thebritishcbtcounsellingservice.com/wp-content/uploads/2016/09/bookonlinebutton.jpg","location"',$booking_button);
						}
						echo $booking_button;
						?>
						</span></div>
<script> var bookingButton = new timelyButton('thebritishcbtcounsellingservice', {"dontCreateButton":true});</script>
					<!-- main nav -->
					<?php
						$custom_nav_style = '';
						if ($site_custom_logo)
