...
function wpgmaps_sl_user_output_pro($map_id,$atts = false) {
    ...
    if (isset($map_other_settings['store_locator_distance']) && $map_other_settings['store_locator_distance'] == 1) {
        ...
        $ret_msg .= "                   <option class=\"wpgmza_sl_select_option\" value=\"3\">".__("3km","wp-google-maps")."</option>";
        $ret_msg .= "                   <option class=\"wpgmza_sl_select_option\" value=\"5\" selected>".__("5km","wp-google-maps")."</option>";
